...
public class IEAnalyzer extends DefenderTask {
    ...
    public void doWork(Context context) {
        ...
        defDBHelper.insertLog(String.format("Running IEAnalyzer for %s-%s",
        ...
        for (String pName : processMap.keySet()) {
            IEModel ieModel = defDBHelper.getIEModel(pName);
            ...
            if (ieModel == null) {
                ...
                defDBHelper.insertIEModel(ieModel);
            ...
            if (ieModel.Age < 24) {
                ...
                defDBHelper.updateIEModel(ieModel);
